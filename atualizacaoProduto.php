...
$dao = new Dao();
session_start();
$ML_idProd = $_POST['MLidProduto'];
$_SESSION['ML_idProd'] = $ML_idProd;

$retornoProduto = $dao->retornoProd($ML_idProd);
...
<div id="cadastro">
      ...
      <h1><font size="6" face="Malgun Gothic" id="titulocad"><center>Atualização de produtos</center></font></h1><br>
        ...
        <br>
        <font face="Malgun Gothic" size="4">Descrição:</font> <br> <textarea  rows="10" cols="40" maxlength="500" name="descricao" id="inputcadnome" style="height: 150px"> <?php echo $retornoProduto['descricao'];?> </textarea> <br>
        <font face="Malgun Gothic" size="4" >Preço:</font><br><input type="text" value="<?php echo $retornoProduto['preco'] ?>" placeholder="R$ ___.___" name="preco" id="inputcadnome">

        <button class="btn btn-outline-warning" id="btn" type="submit" ><b>ATUALIZAR</b></button>
      </form>
    </div>
    </body>
