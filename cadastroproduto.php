...
<div id="cadastro">
      ...
      <form method="POST" enctype="multipart/form-data" action="configusuario.php">
    <input type="file" name="pic" accept="image/*"> <br>
        ...
        <font face="Malgun Gothic" size="4">Preço:</font><br><input type="text" placeholder="" name="preco" id="inputcadnome" value="R$">
